// Tamil Translations (Example - Needs actual translation)
final Map<String, String> taIN = {
  'app_title': 'பிட் மை கோல்ட்', // Bid My Gold
  'greeting': 'வணக்கம்!', // Hello!
  // --- Language Selection ---
  'select_language': 'மொழியைத் தேர்ந்தெடுக்கவும்', // Select Language
  'select_language_error':
      'தயவுசெய்து ஒரு மொழியைத் தேர்ந்தெடுக்கவும்', // Please select a language
  // --- Onboarding ---
  'skip': 'தவிர்', // Skip
  'next': 'அடுத்து', // Next
  'done': 'முடிந்தது', // Done
  ...
  'enter_mobile': 'மொபைல் எண்ணை உள்ளிடவும்', // Enter Mobile Number
  'mobile_hint': '10-இலக்க மொபைல் எண்', // 10-digit mobile number
  ...
  'remember_me': 'என்னை நினைவில் கொள்', // Remember Me
  'return_to_main': 'முதன்மை பயன்பாட்டிற்குத் திரும்பு', // Return to Main App
  // --- Feedback ---
  'send_feedback': 'கருத்தை அனுப்பு', // Send Feedback
  'feedback_title': 'கருத்தை அனுப்பு', // Send Feedback
  'feedback_hint': 'உங்கள் கருத்தை கூறுங்கள்...', // Tell us what you think...
  'submit_feedback': 'கருத்தை சமர்ப்பிக்கவும்', // Submit Feedback
  'submitting': 'சமர்ப்பிக்கிறது...', // Submitting...
  'feedback_sent': 'உங்கள் கருத்துக்கு நன்றி!', // Thank you for your feedback!
  // --- Admin Management ---
  'add_new_admin': 'புதிய நிர்வாகியை சேர்க்க', // Add New Admin
  'edit_admin': 'நிர்வாகியை திருத்து', // Edit Admin
  ...
  // --- Anonymous Home ---
  'how_it_works': 'இது எப்படி வேலை செய்கிறது', // How It Works
  'how_it_works_desc':
      '1. எங்கள் கால்குலேட்டரைப் பயன்படுத்தி உங்கள் கடனை மதிப்பிடவும்.\n2. பதிவுசெய்து உங்கள் தங்கத்தின் விவரங்களைப் பதிவேற்றவும்.\n3. நம்பகமான உள்ளூர் அடகு பிடிப்பவர்களிடமிருந்து ஏலங்களைப் பெறுங்கள்.\n4. சிறந்த சலுகையை ஏற்றுக்கொண்டு கடைக்குச் செல்லுங்கள்!', // How it works description
  'loan_estimator': 'தங்கக் கடன் மதிப்பீட்டாளர்', // Gold Loan Estimator
  'estimator_desc':
      'உங்கள் தங்கத்திற்கு நீங்கள் பெறக்கூடிய கடன் தொகையின் உடனடி மதிப்பீட்டைப் பெறுங்கள்.', // Estimator description
  'get_estimate_cta': 'மதிப்பீட்டைப் பெற்று தொடரவும்', // Get Estimate & Proceed
  'get_started_now': 'இப்போதே தொடங்குங்கள்', // Get Started Now
  // --- Calculator ---
  ...
  // --- Loan Request --- (Tamil Placeholders)
  'loan_request': 'கடன் கோரிக்கை', // Loan Request
  'jewel_details': 'நகை விவரங்கள்', // Jewel Details
  'jewel_type': 'நகை வகை', // Jewel Type
  'necklace': 'கழுத்து மாலை', // Necklace
  'ring': 'மோதிரம்', // Ring
  'bracelet': 'கைவளை', // Bracelet
  'earrings': 'காதணிகள்', // Earrings
  'bangle': 'வளையல்', // Bangle
  'chain': 'சங்கிலி', // Chain
  'pendant': 'தொங்கட்டான்', // Pendant
  'other': 'மற்றவை', // Other
  ...
  'loan_details_section': 'கடன் விவரங்கள்', // Loan Details
  'video_attached': 'வீடியோ இணைக்கப்பட்டது', // Video attached
  'edit_request': 'கோரிக்கையை திருத்தவும்', // Edit Request
  'submit_final_request': 'கோரிக்கையை சமர்ப்பிக்கவும்', // Submit Request
  // --- Dashboard --- (New)
  'dashboard': 'டாஷ்போர்டு', // Dashboard
  'user': 'பயனர்', // User
  'kyc_status': 'KYC நிலை', // KYC Status
  'kyc_pending': 'சரிபார்ப்பு நிலுவையில் உள்ளது', // Verification Pending
  'kyc_verified': 'சரிபார்க்கப்பட்டது', // Verified
  'kyc_rejected': 'சரிபார்ப்பு நிராகரிக்கப்பட்டது', // Verification Rejected
  'update_kyc': 'ஆவணங்களை புதுப்பிக்கவும்', // Update Documents
  ...
  'status_pending': 'நிலுவையில் உள்ளது', // Pending
  'view_bids': 'ஏலங்களைக் காண்க', // View Bids
  'cancel_request': 'கோரிக்கையை ரத்து செய்யவும்', // Cancel Request
  // --- Pawnbroker Registration --- (New)
  'pawnbroker_registration': 'அடகு பிடிப்பவர் பதிவு', // Pawnbroker Registration
  'shop_information': 'கடை தகவல்', // Shop Information
  'document_upload': 'ஆவணம் பதிவேற்றம்', // Document Upload
  'additional_details': 'கூடுதல் விவரங்கள்', // Additional Details
  'previous': 'முந்தைய', // Previous
  'submit': 'சமர்ப்பிக்க', // Submit
  ...
  'city': 'நகரம்', // City
  'city_required': 'நகரத்தை உள்ளிடவும்', // Please enter city
  'state': 'மாநிலம்', // State
  ...
  'offered_amount': 'வழங்கப்பட்ட தொகை', // Offered Amount
  'loan_amount': 'கடன் தொகை', // Loan Amount
  'duration': 'காலம்', // Duration
  'per_month': 'மாதத்திற்கு', // per month
  'accept_bid': 'ஏலத்தை ஏற்றுக்கொள்', // Accept Bid
  'reject_bid': 'ஏலத்தை நிராகரி', // Reject Bid
  'bid_accepted': 'ஏலம் ஏற்றுக்கொள்ளப்பட்டது', // Bid Accepted
  'scheduling_appointment': 'சந்திப்புகளை திட்டமிடல்', // Scheduling Appointment
  'processing': 'செயலாக்கப்படுகிறது...', // Processing...

  // --- Place Bid ---
  'place_your_bid': 'உங்கள் ஏலத்தை வைக்கவும்', // Place Your Bid
  'jewel_assessment': 'நகை மதிப்பீடு', // Jewel Assessment
  'jewel_value': 'நகை மதிப்பு', // Jewel Value
  'bid_amount': 'ஏல தொகை', // Bid Amount
  'bid_interest_rate': 'ஏல வட்டி விகிதம்', // Bid Interest Rate
  'set_bid_parameters': 'ஏல அளவுருக்களை அமைக்கவும்', // Set Bid Parameters
  'enter_bid_amount': 'ஏல தொகையை உள்ளிடவும்', // Enter bid amount
  'enter_interest_rate': 'வட்டி விகிதத்தை உள்ளிடவும்', // Enter interest rate
  'select_tenure': 'காலத்தை தேர்ந்தெடுக்கவும்', // Select tenure
  'emi_calculation': 'EMI கணக்கீடு', // EMI Calculation
  'monthly_payment': 'மாதாந்திர கட்டணம்', // Monthly Payment
  ...
  'select_date_time': 'தேதி & நேரத்தை தேர்ந்தெடுக்கவும்', // Select Date & Time
  ...
  'close': 'மூடு', // Close
  'edit': 'திருத்து', // Edit
  'please_wait': 'தயவுசெய்து காத்திருக்கவும்...', // Please wait...
  ...
  'appointment_details': 'சந்திப்பு விவரங்கள்', // Appointment Details
  'schedule_appointment': 'சந்திப்பை திட்டமிடவும்', // Schedule Appointment
  'appointment_date': 'சந்திப்பு தேதி', // Appointment Date
  'appointment_time': 'சந்திப்பு நேரம்', // Appointment Time
  'select_date': 'தேதியைத் தேர்ந்தெடுக்கவும்', // Select Date
  'select_time': 'நேரத்தைத் தேர்ந்தெடுக்கவும்', // Select Time
  'confirm_appointment': 'சந்திப்பை உறுதிப்படுத்தவும்', // Confirm Appointment
  ...
  'chat_reconnecting': 'மீண்டும் இணைக்கிறது...', // Reconnecting...
  'chat_reconnected': 'மீண்டும் இணைக்கப்பட்டது', // Reconnected
  'chat_offline': 'ஆஃப்லைன்', // Offline
  'chat_online': 'ஆன்லைன்', // Online
  ...
  'light_mode': 'ஒளி பயன்முறை', // Light Mode
  'about': 'பற்றி', // About
  'help': 'உதவி', // Help
  'privacy_policy': 'தனியுரிமைக் கொள்கை', // Privacy Policy
  'terms_conditions': 'விதிமுறைகள் & நிபந்தனைகள்', // Terms & Conditions
  ...
  'error_unknown': 'எதிர்பாராத பிழை ஏற்பட்டது', // An unexpected error occurred
  'error_session_expired': 'அமர்வு காலாவதியானது', // Session expired
  'error_permission_denied': 'அனுமதி மறுக்கப்பட்டது', // Permission denied
  'error_file_upload': 'கோப்பை பதிவேற்ற முடியவில்லை', // Failed to upload file
